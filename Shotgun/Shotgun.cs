...
{
    class Shotgun : Weapon, IDrawable
    {
        ...
        public override void Thrown(Creature thrownBy, Vector2 thrownPos, Vector2? firstFrameTraceFromPos, IntVector2 throwDir, float frc, bool eu)
        {
            ...
            else
            {
                ...
                for (int i = 1; i < bullets; i++)
                {
                    ...
                    this.room.AddObject(new Spark(thrownPos, fireDir * 800f, Color.white, null, 30, 35));


                    Vector2 wantedVector = this.firstChunk.pos + (fireDir * 2500);
                    ...
                    if (result.chunk != null)
                    {
                        if (result.chunk.owner is Creature)
                        {
                            ...
                            (result.chunk.owner as Creature).Violence(result.chunk, fireDir * -this.recoil, this.bodyChunks[1], result.onAppendagePos, Creature.DamageType.Stab, this.bulletdamage, 15f);
                        }
                    }
        ...
        private float OverrideAngle = -15f;
        public bool aimoverride = false;
        public float reloading = 0;
        public float reloadTime = 5.25f;
        public int ammo = 2;
